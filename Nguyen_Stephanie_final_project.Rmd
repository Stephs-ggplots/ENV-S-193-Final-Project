...
**Data Sources: Data on Country GDP are available from [The World Bank](https://data.worldbank.org/indicator/ny.gdp.pcap.cd?end=2021&start=2000) (2000-2020).**
**Data on country water access are avaliable from [UNICEF](https://data.unicef.org/resources/data_explorer/unicef_f/?ag=UNICEF&df=GLOBAL_DATAFLOW&ver=1.0&dq=.WS_PPL_W-UI+WS_PPL_W-QUA+WS_PPL_W-L+WS_PPL_W-I+WS_PPL_W-B+WS_PPL_W-ALB+WS_PPL_W-SM..&startPeriod=1980&endPeriod=2020) (2000-2020).**
...
The take home message of this figure is that country GDP tends to be correlated with access to drinking water. The graph implies a positive relationship between country per capita wealth and the percentage of the population with drinking water. 
